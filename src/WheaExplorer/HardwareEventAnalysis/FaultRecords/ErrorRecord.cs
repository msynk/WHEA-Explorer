...
using WheaExplorer.HardwareEventAnalysis.FaultRecords.PlatformExtensions;
using WheaExplorer.HardwareEventAnalysis.FaultRecords.UefiSections;
using WheaExplorer.HardwareEventAnalysis.RecordModel;
using WheaExplorer.HardwareEventAnalysis.SharedTypes;
