...
using WheaExplorer.HardwareEventAnalysis.KernelTraceEntries.HardwareChannel;
using WheaExplorer.HardwareEventAnalysis.KernelTraceEntries.SoftwareChannel;
